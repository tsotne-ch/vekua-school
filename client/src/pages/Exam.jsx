...
const Exam = () => {
  ...
  // this is for registration dumbass
  ...
  const handleSubmit = (e) => {
    ...
    Swal.fire({
      title: "<p class='font-glaho'>იტვირთება</p>",
      html: "<p class='font-glaho'>გთხოვთ დაიცადოთ, მოსწავლის შეფასება იძებნება</p>",
      allowOutsideClick: false,
      didOpen: () => {
        Swal.showLoading();
      },
    ...
    <div className="items-center container dark:text-white py-20">
      ...
      <div className="">
        <h4 className="mb-3 mt-10 font-glaho text-2xl text-center">
          4, 5 და 6 ივლისს ჩატარებული სარეკომენდაციო წერების პირველადი შედეგები
        </h4>
            ...
            {data.code[0] == "7" ? (
              <div className="text-center font-glaho">
                ...
                {data.points ? (
                  ...
                  <h2 className="text-4xl mt-5">შეფასება არ აქვს</h2>
                )}
              </div>
            ) : (
              <div className="text-center font-glaho">
                ...
                <h2 className="text-4xl mt-5">
                  ფიზიკა:{" "}
                  {!data.physics ? "შეფასება არ აქვს" : "" + data.physics}
                </h2>
              </div>
            )}
          </>
